...
public class Lambda02 {
    ...
    public static void ciftKarePrint(List<Integer> sayi) {
        sayi.
                stream().
                filter(Lambda01::cift). // akışdaki çift sayıları filtreledim , 4,2,6
    ...
    public static void ciftCarp(List<Integer> sayi){
        ...
        System.out.println(sayi.
                stream().
                filter(Lambda01::cift).
                reduce(1, (a, b) -> (a * b))); // lambda expression sonucun null gelme ihtimali yoktur
    }
...
// 2. yol : method refrance
    ...
    public static void ciftKareKbSortPrint(List<Integer> sayi) {
        sayi.
                ...
                filter(Lambda01::cift). // akış içindeki çift sayıları aldım
